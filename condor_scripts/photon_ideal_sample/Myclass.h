...
// Wed May 28 18:51:01 2025 by ROOT version 6.34.08
// from TTree T/MyTuple
// found on file: photon_ideal_merged.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("photon_ideal_merged.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("photon_ideal_merged.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("photon_ideal_merged.root:/nTuplelize");
