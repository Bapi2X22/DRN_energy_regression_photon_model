...
options.inputFile = 'file:/eos/user/b/bbapi/Energy_regression/CMSSW_13_3_3/src/condor_scripts/DY_sample_photon_model/'+ options.inputFile
...
#          'file:/eos/user/b/bbapi/Energy_regression/CMSSW_13_3_3/src/test/miniAOD_New.root'
           options.inputFile
#            'file:/eos/user/b/bbapi/Energy_regression_by_electron_model/CMSSW_13_3_3/src/test/miniAOD_file_2.root'
                ),
...
# Strip off any "file:" prefix and get just the filename
filename = options.inputFile
if filename.startswith("file:"):
    filename = filename[5:]

base_name = os.path.basename(filename).replace('.root', '')
#output_name = f"{base_name}_ntuple.root"
output_folder = "/eos/user/b/bbapi/Energy_regression/CMSSW_13_3_3/src/EM_Skimmer/ZeeAnalyzer/test/DY_nTuplelized_photon_model/"  # <-- Set your desired output folder here
output_name = os.path.join(output_folder, f"{base_name}_ntuple.root")
...
#process.TFileService = cms.Service("TFileService",
#     fileName = cms.string(options.inputFile),
#     closeFileFast = cms.untracked.bool(True)
#  )
