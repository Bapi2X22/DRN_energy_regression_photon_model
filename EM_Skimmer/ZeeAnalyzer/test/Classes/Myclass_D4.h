...
// Fri Mar 14 04:48:06 2025 by ROOT version 6.34.04
// from TTree T/MyTuple
// found on file: merged_4.root
//////////////////////////////////////////////////////////
...
#ifdef Myclass_D4_cxx
Myclass_D4::Myclass_D4(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("merged_4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("merged_4.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("merged_4.root:/nTuplelize");
...
Myclass_D4::~Myclass_D4()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Myclass_D4::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Myclass_D4::LoadTree(Long64_t entry)
{
...
void Myclass_D4::Init(TTree *tree)
{
...
void Myclass_D4::Show(Long64_t entry)
{
...
Int_t Myclass_D4::Cut(Long64_t entry)
{
