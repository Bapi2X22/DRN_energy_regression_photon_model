...
// Fri Mar 14 05:01:30 2025 by ROOT version 6.34.04
// from TTree T/MyTuple
// found on file: merged_1.root
//////////////////////////////////////////////////////////
...
#ifdef Myclass_D1_cxx
Myclass_D1::Myclass_D1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("merged_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("merged_1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("merged_1.root:/nTuplelize");
...
Myclass_D1::~Myclass_D1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Myclass_D1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Myclass_D1::LoadTree(Long64_t entry)
{
...
void Myclass_D1::Init(TTree *tree)
{
...
void Myclass_D1::Show(Long64_t entry)
{
...
Int_t Myclass_D1::Cut(Long64_t entry)
{
