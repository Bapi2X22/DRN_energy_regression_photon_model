...
#     'root://cms-xrd-global.cern.ch/'+ options.inputFile
      'root://cms-xrd-global.cern.ch//store/mc/RunIISummer20UL18RECO/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/AODSIM/106X_upgrade2018_realistic_v11_L1v1-v1/130000/E56F5631-F693-5E4E-9E71-F2708462C61C.root'
    ),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("output_miss_2.root")
)

process.output = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring("keep *"),
                                   fileName = cms.untracked.string("missfile_2.root")
