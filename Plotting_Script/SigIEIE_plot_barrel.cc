...
void Plot_SigIEIE() {
    ...
    for (size_t i = 0; i < fileNames.size(); i++) {
        ...
        TH1F *SigIEIE = (TH1F*) file->Get("SigIEIE");
        if (!SigIEIE) {
        ...
        TH1F *hist = (TH1F*) SigIEIE->Clone(Form("hist_%zu", i));
        hist->Rebin(10);
    ...
    hist->GetXaxis()->SetTitle("Distribution of SigIEIE (Barrel)");
    ...
    c->SaveAs("SigIEIE_dist(Barrel).png");
