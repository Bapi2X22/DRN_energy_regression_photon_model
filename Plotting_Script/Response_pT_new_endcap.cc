...
void plotSigmaOverMu() {
    TFile *file = TFile::Open("Plot_pT_E_1.root", "READ");
    ...
    graph_sigma_BDT->SetTitle("#sigma/#mu vs pT(Endcap)");
    ...
    c->SaveAs("sigma_over_mu_vs_pT_1_endcap.png");
    c->SaveAs("sigma_over_mu_vs_pT_1_endcap.pdf");
    ...
    c1->SaveAs("mu_vs_pT_1_Endcap.pdf");
    c1->SaveAs("mu_vs_pT_1_Endcap.png");
