...
void plotSigmaOverMu() {
    TFile *file = TFile::Open("Plot_pT_4.root", "READ");
    ...
    graph_sigma_BDT->SetTitle("#sigma/#mu vs pT");
    ...
    lateX->DrawTextNDC(0.45, 0.85, "None_varied");
    ...
    c->SaveAs("sigma_over_mu_vs_pT_4.pdf");
    c->SaveAs("sigma_over_mu_vs_pT_4.png");
    ...
    graph_mu_BDT->SetTitle("#mu vs pT");
    ...
    c1->SaveAs("mu_vs_pT_4.pdf");
    c1->SaveAs("mu_vs_pT_4.png");
