...
void plotSigmaOverMu() {
    TFile *file = TFile::Open("Plot_R9_barrel_1.root", "READ");
...
{0.87, 0.89}, {0.89, 0.9}, {0.91, 0.92}, {0.92, 0.93},
    ...
    c->SaveAs("sigma_over_mu_vs_R9_1_barrel.png");
    c->SaveAs("sigma_over_mu_vs_R9_1_barrel.pdf");
    ...
    c1->SaveAs("mu_vs_R9_1_barrel.pdf");
    c1->SaveAs("mu_vs_R9_1_barrel.png");
