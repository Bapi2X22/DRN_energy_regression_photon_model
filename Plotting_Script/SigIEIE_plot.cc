...
void Plot_SigIEIE() {
    ...
    std::vector<std::string> fileNames = {"Plot_all_1.root","Plot_all_2.root","Plot_all_3.root","Plot_all_4.root"};
    ...
    hist->GetXaxis()->SetTitle("Distribution of SigIEIE");
