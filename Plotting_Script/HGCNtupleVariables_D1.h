...
#ifndef HGCNtupleVariables_D1_h
#define HGCNtupleVariables_D1_h
...
class HGCNtupleVariables_D1 {
public:
  HGCNtupleVariables_D1(TTree * /*tree*/ = 0) : fChain(0) {}
  ~HGCNtupleVariables_D1() {}
...
#ifdef HGCNtupleVariables_D1_cxx

void HGCNtupleVariables_D1::Init(TTree *tree, TTree *tree2) {
...
// Set branch addresses and branch pointers
   ...
   fChain->SetBranchAddress("isRefinedSC", &b_isRefinedSC, &b_isRefinedSC);
  if (!tree)
    return;
  Notify();
  return;
...
Bool_t HGCNtupleVariables_D1::Notify() {
...
#endif // #ifdef HGCNtupleVariables_D1_cxx